...
@section('content')
    <section class="relative min-h-screen flex items-center justify-center py-20 overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-cyan-500/10 rounded-full blur-[120px] animate-pulse"></div>
            <div
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-md mx-auto">
                ...
                <div class="text-center mb-10">
                    ...
                    <h2 class="heading-font text-3xl font-black tracking-tighter text-white uppercase italic">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="login" value="{{ old('login') }}" required
                                    class="w-full bg-slate-950/50 border border-slate-800 rounded-xl py-4 pl-12 pr-4 text-white focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 transition-all placeholder:text-slate-700"
