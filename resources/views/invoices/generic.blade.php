...
<body class="antialiased text-slate-800 bg-slate-50 min-h-screen py-6 px-4 flex flex-col items-center justify-start">
    ...
    <div class="max-w-3xl w-full space-y-4">
        ...
        <div
            ...
            <div
                ...
                <div class="text-left sm:text-right sm:ml-auto">
                    <h2 class="text-xl font-black text-slate-400 uppercase tracking-tight">INVOICE</h2>
                    <p class="text-xs text-slate-500 mt-0.5">
                        Date: <span class="font-semibold text-slate-700">{{ now()->format('d M, Y') }}</span>
                    </p>
                    <p class="text-xs text-slate-500 mt-0.5">
                        Status: <span class="font-bold text-emerald-600 uppercase">Successful</span>
                    </p>
                </div>
            </div>
            ...
            <div class="mt-4 flex flex-col items-end text-sm">
                <div class="w-full sm:w-64 space-y-1.5 border-t border-slate-100 pt-3 font-medium text-xs">
            ...
            <div
                ...
                <div class="text-slate-300 font-serif italic text-xs select-none">
                    Thank You!
                </div>
            </div>
        ...
        <p class="no-print text-center text-[9px] font-bold text-slate-400 uppercase tracking-widest pt-2">
