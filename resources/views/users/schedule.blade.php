...
@section('content')
    <section class="py-20 container mx-auto px-6" x-data="{ activeDay: 1 }">
        ...
        <div
            ...
            <div>
                <h2 class="heading-font text-4xl md:text-6xl font-black uppercase tracking-tighter text-white">
                    Event <span
                        class="text-cyan-500 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Timeline</span>
                </h2>
                <p class="text-slate-500 font-mono text-sm mt-2 tracking-widest italic">>> DUET_CSE_FEST_2026_LOG_FILE</p>
            </div>

            <!-- Day Selector Tabs -->
            <div class="flex p-1 bg-slate-900 border border-slate-800 rounded-lg shadow-xl">
        ...
        <div class="mb-12 bg-slate-900/20 border border-cyan-500/20 p-4 rounded-lg flex items-center justify-between">
            <div class="flex items-center gap-4">
                <div class="px-3 py-1 bg-cyan-500/10 text-cyan-400 text-[10px] font-bold rounded border border-cyan-500/20">
                    PRE-EVENT</div>
        ...
        <div class="relative ml-4 md:ml-10 border-l border-slate-800/50">
            ...
            <div x-show="activeDay === 1" x-transition:enter="transition ease-out duration-500"
                ...
                <div class="relative pl-8 pb-12 group">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div class="md:col-span-1">
                            <span class="text-cyan-400 font-black text-xl tracking-tighter">08:00 AM</span>
                        ...
                        <div class="md:col-span-3">
                            <div class="bg-slate-900/40 border border-slate-800 p-6 rounded-xl">
                                <h3 class="text-white font-bold uppercase tracking-wider mb-2 text-lg">Morning Reporting
                                </h3>
                ...
                <div class="relative pl-8 pb-12 group">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div class="md:col-span-1">
                            ...
                            <p class="text-[10px] text-slate-500 font-mono uppercase">30 Min Session</p>
                        </div>
                        <div class="md:col-span-3">
                            <div
                                class="bg-slate-900/40 border border-blue-500/10 p-6 rounded-xl border-l-4 border-l-blue-500">
                                <div class="flex justify-between items-start mb-2">
                                    <h3 class="text-white font-bold uppercase tracking-wider text-xl">ICT Olympiad Exam</h3>
                                    <span
                                        class="bg-blue-500/10 text-blue-400 text-[9px] px-2 py-1 font-bold rounded">EXAM_HALL</span>
                                </div>
                ...
                <div class="relative pl-8 pb-12 group">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div class="md:col-span-1">
                            <span class="text-cyan-400 font-black text-xl tracking-tighter">09:00 AM</span>
                            <p class="text-[10px] text-slate-500 font-mono uppercase">Morning Session</p>
                        </div>
                        <div class="md:col-span-3">
                            <div
                                class="bg-slate-900/40 border border-slate-800 p-6 rounded-xl border-l-4 border-l-cyan-500">
                                <h3 class="text-white font-bold uppercase tracking-wider text-xl mb-2">Project Demonstration
                                </h3>
                ...
                <div class="relative pl-8 pb-12 group">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div class="md:col-span-1">
                            <span class="text-cyan-400 font-black text-xl tracking-tighter">02:30 PM</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="md:col-span-3">
                            <div class="bg-red-500/5 border border-red-500/20 p-6 rounded-xl border-l-4 border-l-red-500">
                                <h3 class="text-white font-bold uppercase tracking-wider text-xl mb-2">IUPC Mock Contest
                                </h3>
            ...
            <div x-show="activeDay === 2" x-transition:enter="transition ease-out duration-500"
                ...
                <div class="relative pl-8 pb-12 group">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div class="md:col-span-1">
                            <span class="text-cyan-400 font-black text-xl tracking-tighter">07:30 AM</span>
                            <p class="text-[10px] text-slate-500 font-mono uppercase">Early Reporting</p>
                        </div>
                        <div class="md:col-span-3">
                            <div class="bg-slate-900/40 border border-slate-800 p-6 rounded-xl">
                                <h3 class="text-white font-bold uppercase tracking-wider mb-2">IUPC & AI Hackathon Reporting
                                </h3>
                ...
                <div class="relative pl-8 pb-12 group">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div class="md:col-span-1">
                            ...
                            <p class="text-[10px] text-slate-500 font-mono uppercase">5 Hour Marathon</p>
                        </div>
                        <div class="md:col-span-3">
                            <div class="bg-red-500/5 border border-red-500/10 p-6 rounded-xl border-l-4 border-l-red-500">
                                <div class="flex justify-between items-start mb-2">
                                    <h3 class="text-white font-bold uppercase tracking-wider text-xl">IUPC Main Contest</h3>
                                    <span
                ...
                <div class="relative pl-8 pb-12 group">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="md:col-span-3">
                            <div
                                class="bg-slate-900/40 border border-purple-500/10 p-6 rounded-xl border-l-4 border-l-purple-500">
                                <h3 class="text-white font-bold uppercase tracking-wider text-xl mb-2">AI Hackathon:
