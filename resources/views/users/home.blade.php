            ...
            <div class="relative w-full h-full overflow-hidden" id="hero-slider">
                ...
                <div class="slider-wrapper flex transition-transform duration-700 ease-in-out h-full">
                    ...
                    <div class="min-w-full h-full relative slide">
                        <!-- object-cover নিশ্চিত করে ইমেজটি ফ্রেম জুড়ে থাকবে -->
                        ...
                        <img src="{{ asset('storage/' . $setting->main_banner1) }}" alt="CSE FEST 1"
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
                            <!-- মোবাইলে টেক্সট বড় করার জন্য text-4xl এবং md:text-7xl ব্যবহার করা হয়েছে -->
                            <h1
                    ...
                    <div class="min-w-full h-full relative slide">
                        ...
                        <img src="{{ asset('storage/' . $setting->main_banner2) }}" alt="CSE FEST 1"
                            class="w-full h-full object-cover opacity-50 md:opacity-60"
                    ...
                    <!-- Slide 3 -->
                    <div class="min-w-full h-full relative slide">
                        <img src="{{ asset('storage/' . $setting->main_banner3) }}" alt="CSE FEST 1"
                            class="w-full h-full object-cover opacity-50 md:opacity-60"
                            onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&q=80&w=2070"
                            class="w-full h-full object-cover opacity-50 md:opacity-60" alt="CSE FEST 2">';">
                        <div class="absolute inset-0 bg-gradient-to-t from-[#020617] via-[#020617]/40 to-transparent"></div>
                ...
                <!-- Navigation Buttons (Hidden on small mobile for cleaner look, flex on md) -->
                ...
                <div class="absolute bottom-12 left-1/2 -translate-x-1/2 flex gap-3 z-10" id="slider-dots">
                    <div class="w-2 h-2 md:w-3 md:h-3 rounded-full bg-cyan-400 dot transition-all duration-300"></div>
                    <div class="w-2 h-2 md:w-3 md:h-3 rounded-full bg-cyan-400/20 dot transition-all duration-300"></div>
                    <div class="w-2 h-2 md:w-3 md:h-3 rounded-full bg-cyan-400/20 dot transition-all duration-300"></div>
                </div>
            </div>
        </div>
