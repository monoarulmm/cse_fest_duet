        ...
        <div class="space-y-20">
            ...
            <section class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="order-2 lg:order-1 space-y-6">
                    ...
                    <div class="about-card p-8 space-y-6">
                        ...
                        <p class="text-sm leading-relaxed" style="color:var(--text-secondary)">
                            DUET CSE Carnival 2026 is organized by the <span class="font-bold"
                                style="color:var(--accent)">Department of
                                CSE, DUET</span>, in association with <span class="font-bold"
                                style="color:var(--accent)">DUET Computer
                                Society</span> and in collaboration with <span class="font-bold"
                                style="color:var(--accent)">WhiteBoard
                                Initiatives</span>. The event is designed to promote technical excellence and innovation
                            through prestigious competitions.
                        </p>

                        <p class="text-xs font-bold uppercase tracking-widest" style="color:var(--text-muted)">Competition
                            Segments</p>
                ...
                <div class="order-1 lg:order-2 relative group">
                    ...
                    <div style="border-color:var(--border-accent); background:var(--bg-surface)">
                        <img src="{{ asset('storage/' . $setting->main_banner3) }}" alt="DUET CSE Carnival 2026"
                            ...
                            onerror="this.onerror=null; this.src='{{ asset('images/banner.png') }}';">
                    </div>
                </div>
            </section>
            ...
            <section x-data="{ activeSegment: 'iupc' }" class="py-12 space-y-8">
                ...
                <div class="text-center space-y-2">
                    <h3 class="font-mono text-xs uppercase tracking-[0.3em]" style="color:var(--accent); opacity:0.7">
                        Explore Segments</h3>
                    ...
                    @foreach ($segments as $seg)
                        <button @click="activeSegment = '{{ $seg['key'] }}'"
                            ...
                            <span class="flex flex-col items-center gap-2">
                                <img src="{{ asset('images/' . $seg['img']) }}" alt="{{ $seg['label'] }}"
                                    :class="activeSegment === '{{ $seg['key'] }}' ? 'brightness-0' :
                ...
                <div class="relative min-h-[220px]">
                    ...
                    @foreach ($contents as $key => $content)
                        <div x-show="activeSegment === '{{ $key }}'"
                            ...
                            <h4 class="text-2xl font-black uppercase mb-4 flex items-center gap-3"
