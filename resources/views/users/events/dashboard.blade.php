    ...
    <div id="page-root">
        ...
        <div class="container mx-auto px-4 py-10 min-h-screen">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-6 border-b border-white/10 pb-8 mb-12">
                <div>
                    <h2 class="heading-font text-3xl font-black  uppercase tracking-tighter">
                        {{ $event->name }} <span class="text-cyan-500"></span>
                    </h2>
                   
                </div>

                <button onclick="window.history.back()"
                    class="flex items-center gap-3 px-6 py-3  border border-slate-700 rounded-2xl
                    ...
                    <span class="text-xs font-bold text-slate-300 uppercase tracking-widest">Back</span>
                </button>
            </div>
                ...
                <div class="flex flex-wrap justify-center gap-4 mb-16">
                    @foreach ($stats as $stat)
                        <a href="{{ $stat['route'] }}"
                            ...
                            {{-- Number --}}
                            <h4
                                class="stat-value-{{ $stat['color'] }} text-3xl font-black 
                ...
                @if (!empty($event->images) && is_array($event->images))
                    <section class="mt-32 cv-auto">
                        <div class="flex flex-col items-center mb-12">
                            ...
                            <h3 class="text-4xl font-black  uppercase tracking-tighter text-center">
                                        ...
                                        <div class="swiper-slide !w-auto">
                                            <div
                                                class="judge-card relative w-[280px] h-[380px] rounded-[2.5rem]
                                                    overflow-hidden border border-white/5  group">
