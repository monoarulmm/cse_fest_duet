...
class PaymentTestController extends Controller
{
    ...
    // Laravel will automatically inject the singleton instance from the service provider
    ...
    public function send_payment_request_to_shurjopay()
    {
        ...
        // This single call handles authentication and payment request
        return $this->shurjopay->makePayment($payment_request);
    }
